function [iq_data, servo_angle, success, is_end] = process_stage1_read_data(frame_to_read, config, DBF_coeffs_C)
...
[iq_data, servo_angle, frameCompleted, is_global_stream_end] = FrameDataRead_xzr(orgDataFilePath, DBF_coeffs_C, Sig_Config, frame_to_read);
