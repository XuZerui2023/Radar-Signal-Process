    ...
    for frameRInd = 0:139 
        ...
        for b = 1:params.beam_num 
            ...
            for i = 1:win_size
                ...
                % 调用本地CFAR处理函数 
                cfarFlag_temp = fun_CFARflag(MTD_temp,refCells_R,saveCells_R,T_CFAR_R,CFARmethod_R,refCells_V,saveCells_V,T_CFAR_V,CFARmethod_V,MTD_0v_num,rCFARDetect_Flag);
